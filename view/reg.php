...
<div class="content" align="center">
	 <form action="../class/regcheck.php" method="post">
	 ...
	 <input class="input_1"  type='password' name='confirm' size=20  placeholder="重复输入" tabindex="3" /><br/><br/>
	   	<span class='login'><input class="login_input" type='submit' size=25 value='注册' /></span>
